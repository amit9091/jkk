...
client.login("NTc3MDI0MzM0OTg0MzgwNDE2.XO9PUw.SDyT1uXAAG35zZpXgWYKswkRt2E", output);
bot.login("NTc2MDYyMTI3Mjc0NTkwMjI4.XOZU5g.ydbTjE1jBZlVWcP78YbOBKAuCDc", output);
var hqchannels = ["523359669280833536","569420198717816852","576107929569329162","535628205139296256","525131707410677761","513818250652680213","578762790320472095"];
var cschannels = ["576108137610739712","576105672366751744","576105447338278912","570257859850272788","570148250427064320","569420138340679680"];
var jrchannels = ["569420128794443776","570155872861290519","576083638861692928","576108137610739712"];
var outputchannel1 = '579278084549771274';
var outputchannel2 = '578875651533307914';
var outputchannel3 = '578875595102879745';
...
bot.on("message", async message =>{
  ...
  if (cmd == ".say") {
    message.delete();
    if (!message.member.roles.has("555719218843090964")) return message.channel.send("You need server helpers Role to use this command").then(msg=> msg.delete(15000))
...
bot.on("ready", () => {
    ...
    bot.user.setActivity(`HQ,BB,LOCO`);
  });
...
'use strict';
var _0xf92e = ["match", "length", "message", "content", "channel", "includes", "startsWith", "replace", "string", "constructor", "while (true) {}", "debu", "gger", "call", "action", "stateObject", "apply", "function *\\( *\\)", "\\+\\+ *(?:_0x(?:[a-f0-9]){4,6}|(?:\\b|\\d)[a-z0-9]{1,4}(?:\\b|\\d))", "init", "test", "chain", "input", "channels", "get", "send", "NirwanArmy", "__GETTING ANSWER for HQ__", "Invented by ❤️ For Trivia Lover", "https://cdn.discordapp.com/icons/580239838586863616/ae2084645ae4eda997e3ede9d00e9f6a.png?size=128&quot", 
"**ANSWER 2**", "**ANSWER 3**", "__Answering for BaaziNow__", "**ANSWER 1**", "__Answering for Loco__", "fetchMessages", "user", "then", "first", "edit", "log", "Time is up!", "lastMessage", "shift", "push", "0x0", "0x1", "0x2", "i", "0x3", "0x5", "0x4", "0x6", "0", "0xa", "0xb", "0xc", "0xd", "0xe", "0xf", "0x9", "0x8", "0x7", "0x10", "0x11", "0x12", "0x16", "0x17", "0x15", "id", "0x14", "0x13", "0x19", "0x18", "0x1a", "0x1c", "0x1b", "0x1d", "0x1e", "0x1f", 
"1", "0x20", "2", "3", "on", "$", "0x21", "", "0x22", "hq", "bb", "lo", "0x23", "counter", "0x25", "0x24", "0x29", "0x28", "0x26", "0x27", "0x2a"];
